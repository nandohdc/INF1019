...
*                                              *
*Trabalho 02 - Gerenciador de Memoria First Fit*
*                                              *
...
/***********************************************************************
*                                                                      *
*  $FC Função: ReadyToMemory -> FIRST FIT                              *
*                                                                      *
*                                                                      *
***********************************************************************/
void ReadyToMemory(ListOfProcesses *Lprocesses, Memory *Memory){//FIRST FIT
	int partAux;
	int i;

	for (i = 0; i < 5; i++) {
		if (Memory->LMemory->proc[i].order == -1 && (Memory->LMemory->proc[i].partition >= Lprocesses->proc[0].Memory)) {
