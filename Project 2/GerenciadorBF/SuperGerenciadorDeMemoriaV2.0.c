...
*                                              *
*Trabalho 02 - Gerenciador de Memoria Best Fit *
*                                              *
...
/***********************************************************************
*                                                                      *
*  $FC Função: ReadyToMemory -> BEST FIT                              *
*                                                                      *
*                                                                      *
***********************************************************************/
void ReadyToMemory(ListOfProcesses *Lprocesses, Memory *Memory){//BEST FIT
	int partAux;
	int i;
	...
	if ((Lprocesses->proc[0].Memory > 4) && (Lprocesses->proc[0].Memory <= 8)){
		...
		if (Memory->LMemory->proc[1].order == -1){
		...
		else if (Memory->LMemory->proc[0].order == -1){ //proc[0]->8Mb e order == -1->vazio
			partAux = Memory->LMemory->proc[0].partition;
			Memory->LMemory->proc[0] = Lprocesses->proc[0];
			Memory->LMemory->proc[0].partition = partAux; //mantendo a partição fixa da memória
			Memory->mOrder = Memory->mOrder + 1;
		...
		if (Memory->LMemory->proc[2].order == -1){
